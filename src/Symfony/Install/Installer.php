...
class Installer implements InstallerInterface
{
    ...
    protected $command;
    protected $gitIgnoreEntries = array(
    ...
    protected $skeleton = 'http://symfony.com/download?v=Symfony_Standard_Vendors_';
     ...
     */
    public function checkSymfonyVersionIsInstallable()
    {
    ...
    public function download()
    {
        ...
        $symfonyArchiveFile = $distill
            ...
            ->addFilesWithDifferentExtensions($this->skeleton.$this->version, ['zip', 'tgz'])
            ->getPreferredFile()
        ;
     ...
     * @return NewCommand
     */
    public function displayInstallationResult()
    {
     ...
     * @return NewCommand
     */
    public function checkSymfonyRequirements()
    {
